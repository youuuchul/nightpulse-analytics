...
- 생성 약 4.5분, 검증 약 2분(노트북 1대 기준, 210,000명 규모). 사람 수는 광고 유입 신규(약 5.4만) + 자연 유입 신규로, 자연 유입 신규가 4월 이후 하루 400~700명이 되는 규모다.
...
관측 마지막 날 경계 점검(생성 초기에 마지막 날만 신청·결제·23시대가 비는 사고가 있어 추가): 마지막 날 시간별 세션 0~23시 전부 존재 · 마지막 날 신청 건수 > 0 · 마지막 날 결제 건수 > 0 · 마지막 날 방문자 ≥ 직전 7일 평균의 60% · 마지막 7일 일평균 신청 ≥ 직전 4주 일평균의 70%(종료일 이후 행사가 없어 마지막 주 신청이 꺼지던 사고).

유입 바닥 점검: 캠페인 없는 주의 일평균 신규(사람 첫 방문일) ≥ 캠페인 있는 주의 40%(광고 공백기에 신규가 80% 꺼지던 사고).
...
## 기준 실행 결과 (seed 20260923, 52주, 210,000명)

| 항목 | 값 |
|---|---|
| 이벤트 행 | 9,642,756 |
| 기기 / 사람 | 217,706 / 210,000 |
| 회원 | 22,008 (10.5%) |
| 신청 / 티켓 결제 / 취소 | 64,663 / 37,025 / 4,951 |
| 리텐션 W1 / W2 / W4 / W8 / W12 | 0.227 / 0.136 / 0.090 / 0.078 / 0.070 |
| 방문 → 가입 / 회원 2기기 | 0.105 / 0.350 |
| 상세 → 신청 / 신청 → 결제 / 취소율 | 0.063 / 0.710 / 0.077 |
| 광고 세션 비중(집행일) / 자동 로드 | 0.159 / 0.072 |
| 캠페인별 광고 세션 ÷ 클릭 | 0.59 ~ 0.81 |
| 신규 일평균 (캠페인 없는 주 / 있는 주) | 416 / 795 |
| 마지막 7일 / 직전 4주 일평균 신청 | 404 / 387 |
